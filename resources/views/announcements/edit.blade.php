        ...
        <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 mt-6">
            ...
            <div class="mb-8">
                ...
                <p class="text-slate-500 mt-1">
                    Update the information of this announcement.
                </p>
                ...
                <div class="mb-6">
                    ...
                    >
                        ...
                        <option value="Academic"
                            {{ old('category', $announcement->category) === 'Academic' ? 'selected' : '' }}>
                            Academic
                        </option>

                        <option value="Event"
                            {{ old('category', $announcement->category) === 'Event' ? 'selected' : '' }}>
                            Event
                        </option>

                        <option value="Important"
                            {{ old('category', $announcement->category) === 'Important' ? 'selected' : '' }}>
                            Important
                        </option>

                        <option value="Emergency"
                            {{ old('category', $announcement->category) === 'Emergency' ? 'selected' : '' }}>
                            Emergency
                        </option>
